	...
	protected Query getRangeQuery(String field, String part1, String part2, boolean inclusive) throws ParseException {
		if(field.equals("attach")) {	// 根据int类型字段区域查询
			...
			if(pattern.matcher(part1).matches()&&pattern.matcher(part2).matches()) {
				...
				throw new ParseException("要检索的日期格式不正确");
			}
		}
		return super.newRangeQuery(field, part1, part2, inclusive);	// 根据string类型区域查询
	}
}
